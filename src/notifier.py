...
def handle_start(message: telebot.types.Message):
    ...
    if response.status_code == 200:
        ...
        bot.reply_to(message, "Hello, user. Please provide your username.")
...
def send_telegram_notification(message: str, target_chat_ids: list[int] | None = None):
    """Send a notification message to the configured Telegram chat."""
    recipients = target_chat_ids if target_chat_ids is not None else chat_ids
